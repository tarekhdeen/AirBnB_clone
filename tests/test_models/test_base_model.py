#!/usr/bin/python3
"""Module of BaseModel class Unittest"""
...
class TestBaseModel(unittest.TestCase):
    ...
    def test_attributes(self):
        """Test attributes value for instance of BaseModel class."""
    ...
    def test_id(self):
        ...
        j = [BaseModel().id for i in range(1000)]
    ...
    def test_instantiation_dict(self):
        ...
        d = {"__class__": "BaseModel",
             "updated_at": datetime(2050, 12, 30, 23, 59,
                                    59, 123456).isoformat(),
